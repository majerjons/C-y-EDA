...
#include "raymath.h"
 ...
 // Bonus: Júpiter 1000 veces más masivo
 //#define JUPITER_MASIVO

#ifdef JUPITER_MASIVO
#define FACTOR_JUPITER 1000
#else
#define FACTOR_JUPITER 1
#endif

// Bonus: Agujero Negro
//#define AGUJERO_NEGRO
...
EphemeridesBody solarSystem[] = {
	...
	#ifdef AGUJERO_NEGRO
	{
		...
		3E4,
		BLACK,
		{6.431790029686977E+12F, -10.954348456482631E+10F, -4.114486878028781E+11F},
		{0 , 0 , 0 },
	},
	#endif
};
